    ...
    return (
        ...
        >
            ...
            <Text style={styles.title}>KajianQu</Text>
            ...
            <Animated.View entering={SlideInLeft.delay(500)} style={styles.feature}>
                ...
                <Text style={styles.featureText}>ahaerhrahahaha</Text>
            </Animated.View>
            <Animated.View entering={SlideInRight.delay(600)} style={styles.feature}>
                <Award size={24} color="white" />
                <Text style={styles.featureText}>ahahahahah</Text>
            </Animated.View>
            <Animated.View entering={SlideInLeft.delay(700)} style={styles.feature}>
                <Users size={24} color="white" />
                <Text style={styles.featureText}>araejrejaaerjrae</Text>
            </Animated.View>
